console.log("super user js loaded")
...
$('#superuserOfferForm').on('submit', function (e) {
e.preventDefault();  
...
$(document).ready(function() {
    ...
    $('#saveEditedOfferBtn').click(function(e) {
        ...
        if (discountValue.val() && discountValue.val() <= 0) {
            show3Error(discountValue, "Please enter a valid discount percentage.");
            return false;
        } 
